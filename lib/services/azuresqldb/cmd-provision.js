...
var sqldbProvision = function (log, params) {
    ...
    this.fixupParameters = function () {
        ...
        if (_.isUndefined(params.parameters.sqldbParameters.properties.transparentDataEncryption)) {
            //setup default value for TDE parameter
            params.parameters.sqldbParameters.properties.transparentDataEncryption = 'Disabled';
        }
    ...
    this.provision = function (sqldbOperations, resourceGroup, next) {
        ...
        if (!privilege.allowToCreateSqlServer) {
            ...
            async.waterfall([
                ...
                var tde = params.parameters.sqldbParameters.properties.transparentDataEncryption;
